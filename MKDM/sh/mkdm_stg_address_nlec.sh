#!/bin/ksh
#*******************************************************************************
#** Program         :  mkdm_stg_address_nlec.sh
#** 
#** Job Name        :  
#** 
#** Original Author : 
...
if [ $start_step -le $step_number ] ; then   
   ...
   run_sql  mkdm_address_prd_acct_nlec $data_tablespace
   check_status
fi
...
if [ $start_step -le $step_number ] ; then
   echo "*** Step Number $step_number"
   analyze_table mkdm  address_prd_acct 50
   check_status
fi
...
if [ $start_step -le $step_number ] ; then   
   echo "*** Step Number $step_number"
   run_sql  mkdm_address_acct_nlec $data_tablespace 
   check_status
fi
...
if [ $start_step -le $step_number ] ; then
   echo "*** Step Number $step_number"
   analyze_table mkdm  address_acct 50
   check_status
fi
...
if [ $start_step -le $step_number ] ; then
   echo "*** Step Number $step_number"
   run_sql mkdm_stg_address_nlec $data_tablespace 
   check_status
fi
...
if [ $start_step -le $step_number ] ; then
   echo "*** Step Number $step_number"
   analyze_table mkdm stg_address 50
   check_status
fi
