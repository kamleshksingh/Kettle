#!/bin/ksh
#*******************************************************************************
#** Program         :  mkdm_stg_customer_product_acct_nlec.sh
#** 
#** Job Name        :  
#** 
#** Original Author : 
...
if [ $start_step -le $step_number ] ; then   
   ...
   run_sql  mkdm_stg_customer_product_acct_nlec $data_tablespace 
   check_status
fi
...
if [ $start_step -le $step_number ] ; then
   echo "*** Step Number $step_number"
   analyze_table mkdm  stg_customer_product_acct 50
   check_status
fi
