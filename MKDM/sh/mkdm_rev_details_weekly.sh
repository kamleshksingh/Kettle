#!/bin/ksh
#*******************************************************************************
#** Program         :  	mkdm_rev_details_weekly.sh
#** 
#** Job Name        :  	MKDMREVDTL
#**
...
#**		        MKDM_REVENUE_DET from STG_MKDM_BKD_BLG_DTL , MKDM_PROD_UNIT_TYPE_D
#**                     and MKDM_LOAD_CONTROL tables in FINEDW 
#**
...
#-----------------------------------------------------------------
step_number=1
# Description:  Insert records into MKDM_REVENUE_DET_TEMP table from
#               STG_MKDM_BKD_BLG_DTL, MKDM_PROD_UNIT_TYPE_D and
#               MKDM_LOAD_CONTROL tables in FINEDW
#-----------------------------------------------------------------
if [ $start_step -le $step_number ] ; then
   echo "*** Step Number $step_number"
   echo $data_tablespace
   run_sql mkdm_ld_rev_dtl_temp.sql $data_tablespace
   check_status
fi
#-----------------------------------------------------------------
step_number=2
