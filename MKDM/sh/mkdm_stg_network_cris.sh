#!/bin/ksh
#*******************************************************************************
#** Program         :  mkdm_stg_network_cris.sh
#** 
#** Job Name        :  
#** 
#** Original Author : Sanjeev Chaudhary 
#**
#** Description     :  Script to load  network data from CDW
#**
...
#-----------------------------------------------------------------
check_variables start_step ORA_CONNECT CDW_DB_LINK MKDM_ERR_LIST 
...
if [ $start_step -le $step_number ] ; then   
    truncate_table STG_NETWORK_CRIS  
    check_status
fi
...
#-----------------------------------------------------------------
if [ $start_step -le $step_number ] ; then   
   nuke_all MKDM STG_NETWORK_CRIS PER
   check_status
fi
...
#-----------------------------------------------------------------
if [ $start_step -le $step_number ] ; then   
   run_sql  mkdm_stg_network_cris $CDW_DB_LINK $RBS_LARGE 
...
#-----------------------------------------------------------------
if [ $start_step -le $step_number ] ; then
   build_all MKDM STG_NETWORK_CRIS PER
   check_status
fi
