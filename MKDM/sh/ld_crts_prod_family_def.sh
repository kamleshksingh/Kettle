#!/bin/ksh
#*******************************************************************************
#** Program         : ld_crts_prod_family_def.sh
#** 
#** Job Name        :  
#** 
#** Original Author : drray
#**
#** Description     :  
#**                   
#**
...
if [ $start_step -le  $step_number ] ; then
   sqlplus -s $ORA_CONNECT_MKDM  <<_EOF_
      ...
      @${SQLDIR}/crts_prod_family_def $CDW_DB_LINK
_EOF_
   check_status  
fi
...
#-----------------------------------------------------------------
success_msg="Table crts_prod_family_def loaded successfully"
subject_msg="crts_prod_family_def loaded successfully"
